...
export default function Settings() {
  ...
  const allImportableSelected =
    ...
    importableCandidates.every((candidate) =>
        ...
        {workspaceId && (
          <>
            ...
            <BulkRepoImport
              ...
              isDiscovering={discoverRepoImportCandidates.isPending}
              isImporting={addRepos.isPending}
              onBrowseFolders={handleBrowseRepoFolders}
              onToggleCandidate={toggleImportCandidate}
              onToggleAll={toggleAllImportCandidates}
              onImportSelected={handleImportSelectedRepos}
            />
            {addRepo.isError && (
